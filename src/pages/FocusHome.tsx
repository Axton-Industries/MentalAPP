...
import { Brain, ArrowLeft, Eye, Search } from 'lucide-react';
...
const focusGames = [
    {
        ...
        bg: 'bg-emerald-50',
        desc: 'Identifica el color del texto ignorando su significado'
    },
    {
        id: 'visual',
        ...
        color: 'text-teal-500',
        bg: 'bg-teal-50',
        desc: 'Encuentra los objetivos ocultos entre distractores'
    },
];
    ...
    return (
        <div className="min-h-[85vh] flex flex-col items-center py-8 md:py-12 px-4">
            ...
            <div className="text-center mb-10 md:mb-16 animate-fade-in">
                <div className="inline-flex items-center justify-center p-3 bg-emerald-600 text-white rounded-2xl mb-4 shadow-lg shadow-emerald-200">
                    <Brain className="w-6 h-6 md:w-8 md:h-8" />
                </div>
                <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-4 tracking-tight">
                    Entrenamiento de <span className="text-emerald-600">Atención</span>
                </h1>
                <p className="text-lg md:text-xl text-gray-500 max-w-md mx-auto px-4">
                    Mejora tu concentración, velocidad de procesamiento y control inhibitorio.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full max-w-4xl">
                {focusGames.map((game) => (
                    <Card
                        key={game.id}
                        hover
                        className="group cursor-pointer p-6 md:p-8 relative overflow-hidden border-emerald-100"
                        onClick={() => navigate(`/focus/game/${game.id}`)}
                    >
                        ...
                        <div className="mt-6 md:mt-8 flex justify-end relative z-10">
                            <Button variant="ghost" className="group-hover:translate-x-2 transition-transform text-emerald-600 text-sm md:text-base">
                                Comenzar →
                            </Button>
                        </div>
                    </Card>
